package com.malo.monkeylearn.controller;
...
import com.malo.monkeylearn.annotation.AuthCheck;
import com.malo.monkeylearn.common.BaseResponse;
import com.malo.monkeylearn.common.DeleteRequest;
import com.malo.monkeylearn.common.ErrorCode;
import com.malo.monkeylearn.common.ResultUtils;
import com.malo.monkeylearn.config.WxOpenConfig;
...
import com.malo.monkeylearn.model.dto.user.UserAddRequest;
import com.malo.monkeylearn.model.dto.user.UserLoginRequest;
import com.malo.monkeylearn.model.dto.user.UserQueryRequest;
import com.malo.monkeylearn.model.dto.user.UserRegisterRequest;
import com.malo.monkeylearn.model.dto.user.UserUpdateMyRequest;
import com.malo.monkeylearn.model.dto.user.UserUpdateRequest;
...
import static com.malo.monkeylearn.service.impl.UserServiceImpl.SALT;
...
public class UserController {
    ...
    public BaseResponse<List<Integer>> getUserSignInRecord(Integer year, HttpServletRequest request) {
        // 必须要登录才能签到
        User loginUser = userService.getLoginUser(request);
        List<Integer> userSignInMap = userService.getUserSignInMap(loginUser.getId(), year);
        return ResultUtils.success(userSignInMap);
    }
}
